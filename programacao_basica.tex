...
\begin{itemize}
    ...
    \end{itemize}
    O motivo pelo qual se deve evitar ao máximo os comandos break, continue e goto é simples: Eles alteram o runtime padrão do C. E isso não é bom. Pode dar pau se você ficar usando sem para
\end{itemize}
